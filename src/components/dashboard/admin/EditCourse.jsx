  ...
  useEffect(() => {
    if (details) {
      setFormData({
        ...
        publisher: details.publisher || "Self-Published",
        publishDate: details.publishDate ? details.publishDate.split("T")[0] : "",
        description: details.description || "",
        image: details.image || "",
      });
      if (details.sections) {
        setSections(JSON.parse(JSON.stringify(details.sections))); // Deep copy
      }
    }
  }, [details]);
    ...
    <div className="bg-white rounded-xl shadow-lg relative p-6 w-full max-w-6xl max-h-[90vh] overflow-y-auto">
      ...
      <div className="flex items-center justify-between border-b pb-4 mb-6">
        <div>
          ...
          <p className="text-slate-500 text-xs mt-1">Modify your course details, lectures, and curriculum structure</p>
        </div>
        <button
          onClick={onClose}
            ...
            <div className="bg-slate-50/50 border border-slate-100 rounded-xl p-5 space-y-4">
              ...
              <div className="space-y-4">
                {sections.map((section, sIndex) => (
                  <div key={section._id || sIndex} className="border border-slate-200 rounded-xl p-4 bg-slate-100/50 space-y-3">
                    <div className="flex items-center justify-between pb-2 border-b border-slate-200">
