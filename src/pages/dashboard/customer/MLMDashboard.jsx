...
const MLMDashboard = () => {
  const stats = [
    ...
    { name: "Active Members", value: "18", icon: <Activity className="h-5 w-5" /> },
    { name: "This Month Earnings", value: "$1,245", icon: <DollarSign className="h-5 w-5" /> },
    { name: "Lifetime Earnings", value: "$8,760", icon: <DollarSign className="h-5 w-5" /> }
  ];

  const teamMembers = [
    { id: 1, name: "Sarah Johnson", level: 1, joinDate: "2023-01-15", status: "active" },
    { id: 2, name: "Michael Chen", level: 2, joinDate: "2023-02-28", status: "active" },
    { id: 3, name: "Emily Wilson", level: 1, joinDate: "2023-03-10", status: "inactive" }
  ];
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {teamMembers.map(member => (
                  <tr key={member.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Level {member.level}</td>
