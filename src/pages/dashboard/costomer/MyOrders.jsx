...
const MyOrders = () => {
  const orders = [
    { id: '#12345', date: '2023-05-15', total: 49.99, status: 'completed', items: 3 },
    { id: '#12346', date: '2023-06-02', total: 29.99, status: 'pending', items: 1 },
    { id: '#12347', date: '2023-06-10', total: 99.99, status: 'cancelled', items: 5 }
  ];
